source ../.env
echo getTotalUsers $(cast call $ANVIL_USER_REGISTER_PROXY_ADDRESS "getTotalUsers()(uint256)" --rpc-url $ANVIL_RPC_URL)
echo getAllNicks $(cast call $ANVIL_USER_REGISTER_PROXY_ADDRESS "getAllNicks()(string[])" --rpc-url $ANVIL_RPC_URL)
